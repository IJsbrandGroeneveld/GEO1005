...
<qgis version="2.10.1-Pisa" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="green_perc">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="wanted_perc">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="Dissolved_osm_id">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="Dissolved_name">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="Dissolved_type">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="Dissolved_distance">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="Dissolved_green_area">
      <widgetv2config IsMultiline="0" fieldEditable="0" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{b4167896-db6a-488f-956b-d703bf7fd150}">
      <rule filter="green_perc >= 0.0 AND green_perc &lt;= 6.67 " key="{9825544c-a679-41ac-af7c-10012f165b6f}" symbol="0" label="Onvoldoende "/>
      <rule filter="green_perc >= 6.67 AND green_perc &lt; 10" key="{9825544c-a679-41ac-af7c-10012f165b6f}" symbol="1" label="Matig "/>
      <rule filter="green_perc >= 10" key="{1e6b826e-d631-4fa1-8e6f-b23733e83b61}" symbol="2" label="Goed "/>
    </rules>
    <symbols>
  ...
  <displayfield>green_perc</displayfield>
  <label>0</label>
  <labelattributes>
